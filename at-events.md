...
| Action:                       | Description:                                                 |
| ----------------------------- | ------------------------------------------------------------ |
| `openpages.user.logoff`         | An event is generated when a user logs out of IBM OpenPages. |
| `openpages.user.logon`         | An event is generated when a user logs in to IBM OpenPages   |
