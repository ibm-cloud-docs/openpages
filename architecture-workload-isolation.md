...
![Tenant isolation architecture](op_saas_isolation.svg "Tenant isolation architecture"){: caption="Figure 1. Main components of OpenPages as a Service" caption-side="bottom"}
