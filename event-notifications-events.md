...
6. Select the resource group and {{site.data.keyword.en_short}} service instance that you want to connect.
    ...
    If an IAM authorization between {{site.data.keyword.openpages_short}} and {{site.data.keyword.en_short}} doesn't exist in your account, a dialog is displayed. Follow the prompts to grant access between the services.

    1. To grant access between {{site.data.keyword.openpages_short}} and {{site.data.keyword.en_short}}, click **Authorize**.
