...
Use the {{site.data.keyword.la_full}} service to view {{site.data.keyword.openpages_short}} logs for your instance.
{: shortdesc}
...
5. In the logging UI, filter by `secrets-manager` to view logs that are generated by {{site.data.keyword.openpages_short}}.
