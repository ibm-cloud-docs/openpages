...
## Configuring IBM Cloud SAML service provider and IAM to use single sign-on (SSO)
{: #iam-saml-config}
...
To configure IBM Cloud SAML, do the following steps:
1. Configure the integration by doing the steps in the following topic: [Federating with the IBM Cloud SAML service provider](https://cloud.ibm.com/docs/account?topic=account-ibm-idp-integration#federate-cloud-saml).
