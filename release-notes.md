...
**9.2.1.2 Release notes**
For AWS US East ( us-east-1 ), AWS Mumbai ( ap-south-1 ), AWS Europe ( eu-central-1 ), IBM Cloud Asia Pacific (Sydney), IBM Cloud Dallas (us-south) and IBM Cloud Frankfurt (eu-de) regions
...
:   AWS RDS db2 engine version upgraded
:   ROSA and ROKS cluster versions upgraded for improved performance and security
